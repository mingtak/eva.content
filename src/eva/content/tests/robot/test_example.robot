...
#
#  $ bin/test -s eva.content -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src eva.content.testing.EVA_CONTENT_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/eva/content/tests/robot/test_example.robot
#
